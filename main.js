...
document.writeln(mynum)//output:3,4,5,6,7
//sorting an array ascending order
let mynum1=num.sort((a,b)=>{
    return a-b;
})
document.writeln(mynum1);//output: 1,2,3,4,5,6,7
//sorting in descending order
let mynum2=num.sort((a,b)=>{
    return b-a;
})
document.writeln(mynum2);//output:7,6,5,4,3,2,1

//sorting array in random order
const mynum3=num.sort(()=>{
    return 0.5-Math.random();
});
document.writeln(mynum3);//output:2,5,4,6,1,7,3

//finding the largest number form a given array
const mynum4=((value)=>{
    return Math.max.apply(null,value);
});
document.writeln(mynum4(num));//Output:7

//getting the minimum value
const mynum5=((value)=>{
    return Math.min.apply(null,value);
});
document.writeln(mynum5(num));//Output:1